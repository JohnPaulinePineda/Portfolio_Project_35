...
GBM_DALEX_PartialDependencePlot_PERCAP <- model_profile(GBM_DALEX, variables = "PERCAP")

(GBM_DALEX_PDP_INFMOR <- plot(GBM_DALEX_PartialDependencePlot_INFMOR, geom = "profiles"))
(GBM_DALEX_PDP_NCOMOR <- plot(GBM_DALEX_PartialDependencePlot_NCOMOR, geom = "profiles"))
(GBM_DALEX_PDP_CLTECH <- plot(GBM_DALEX_PartialDependencePlot_CLTECH, geom = "profiles"))
(GBM_DALEX_PDP_PERCAP <- plot(GBM_DALEX_PartialDependencePlot_PERCAP, geom = "profiles"))
