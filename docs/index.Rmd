...
|      **[A.6]** <span style="color: #FF0000">SANSER</span> = High skewness even after shape transformation
...
|      **[A.9]** <span style="color: #FF0000">SUIRAT</span> = High outlier count even after shape transformation
|
...
|             **[A.2.1]** 1/14 instance labels = <span style="color: #FF0000">COUNTRY</span> variable (character)
|             **[A.2.2]** 1/14 response = <span style="color: #FF0000">LIFEXP</span> variable (numeric)
|             **[A.2.3]** 12/14 predictors = 10/12 numeric + 2/12 factor
|                      **[A.2.3.1]** <span style="color: #FF0000">GENDER</span> (factor)
|                      **[A.2.3.2]** <span style="color: #FF0000">CONTIN</span> (factor)
|                      **[A.2.3.3]** <span style="color: #FF0000">UNEMPR</span> (numeric)
|                      **[A.2.3.4]** <span style="color: #FF0000">INFMOR</span> (numeric)
|                      **[A.2.3.5]** <span style="color: #FF0000">GDP</span> (numeric)
|                      **[A.2.3.6]** <span style="color: #FF0000">CLTECH</span> (numeric)
|                      **[A.2.3.7]** <span style="color: #FF0000">PERCAP</span> (numeric)
|                      **[A.2.3.8]** <span style="color: #FF0000">RTIMOR</span> (numeric)
|                      **[A.2.3.9]** <span style="color: #FF0000">HEPIMM</span> (numeric)
|                      **[A.2.3.10]** <span style="color: #FF0000">HOSBED</span> (numeric)
|                      **[A.2.3.11]** <span style="color: #FF0000">RURPOP</span> (numeric)
|                      **[A.2.3.12]** <span style="color: #FF0000">NCOMOR</span> (numeric)
|
...
##################################
(FE_PCC <- abs(cor(PME.Numeric, method="pearson")[-10,10]))
...
##################################
(FE_SRCC <- abs(cor(PME.Numeric, method="spearman")[-10,10]))
