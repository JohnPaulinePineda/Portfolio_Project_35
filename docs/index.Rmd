...
(GBM_DALEX_GPDP_GENDER <- plot(GBM_DALEX_PartialDependencePlot_GENDER,
                               geom = "profiles"))
(GBM_DALEX_GPDP_CONTIN <- plot(GBM_DALEX_PartialDependencePlot_CONTIN,
                               geom = "profiles"))
...
|
|
####  1.3.9.3 Dataset Level Exploration : Accumulated Local Profiles (DLE_ALP)
|
|
...
|
|
####  1.3.9.4 Instance Level Exploration : Breakdown Plots (ILE_BP)
|
|
...
|
|
####  1.3.9.5 Instance Level Exploration : Shapley Additive Explanations (ILE_SHAP)
|
|
...
|
|
####  1.3.9.6 Instance Level Exploration : Local Interpretable Model-Agnostic Explanations (ILE_LIME)
|
|
...
|
|
####  1.3.9.7 Instance Level Exploration : Ceteris Paribus Profiles (ILE_CPP)
|
|
...
|
|
####  1.3.9.8 Instance Level Exploration : Local Fidelity Plot (ILE_LFP)
|
|

<details><summary><mark style="background-color: #000000;color: #FFFFFF">**Code Chunk | Output**</mark></summary>

```{r section_1.3.9.8, warning=FALSE, message=FALSE}
```

</details>
|
|
####  1.3.9.9 Instance Level Exploration : Local Fidelity Plot (ILE_LSP)
|
|

<details><summary><mark style="background-color: #000000;color: #FFFFFF">**Code Chunk | Output**</mark></summary>

```{r section_1.3.9.9, warning=FALSE, message=FALSE}
```
