...
# model development
##################################
PME.Model.Predictors <- PME[,c("INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED")]
MD <- PME[,c("INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED","LIFEXP")]
...
##################################
set.seed(12345678)
KFold_Indices <- createFolds(PME$LIFEXP,
                             k = 10,
                             returnTrain=TRUE)
...
# for the Stochastic Gradient Boosting
##################################
...
##################################
set.seed(12345678)
GBM_Tune <- train(x = PME.Model.Predictors, 
                  y = PME$LIFEXP,
                  method = "gbm",
                  tuneGrid = GBM_Grid,
...
###  1.3.7 Model Performance Estimation
|
|
...
plot(GBM_DALEX_Performance, geom = "boxplot")
