...
##################################
# Investigating the shape for the numeric predictors
##################################
...
# train set
##################################
PMA <- DPA_BoxCoxTransformed[,!names(DPA_BoxCoxTransformed) %in% c("YEAR","GNI","DPTIMM","RURPOP")]
...
featurePlot(x = PME.Predictors.Numeric, 
            ...
            type = c("p", "smooth"),
            span = .5,
            layout = c(5, ceiling(ncol(PME.Predictors.Numeric)/5)))
...
###  1.3.8 Model Performance Validation
|
|
