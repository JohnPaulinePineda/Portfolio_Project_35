...
|
| Model-independent feature importance metrics were evaluated for the numeric predictors in the study to determine the most optimal subset of variables for the subsequent modelling process which included the following:
|
...
|
###  1.2.3 Model Hyperparameter Tuning
|
...
|
###  1.2.5 Model Presentation
|
| Due to the black-box nature of the regression models considered in the study, model presentation was conducted post-hoc and focused on model-agnostic techniques which did not consider any assumptions about the model structures. These methods were grouped into two categories:
|
...
|      **[A.5]** **PLS: Partial Least Squares** (<mark style="background-color: #CCECFF">**pls**</mark> package)
|             **[A.5.1]** Root Mean Square Error = 2.4242
|             **[A.5.2]** R-Squared = 0.9050
|
...
|      **[B.5]** **PLS: Partial Least Squares** (<mark style="background-color: #CCECFF">**pls**</mark> package)
|             **[B.5.1]** Root Mean Square Error = 2.4632
|             **[B.5.2]** R-Squared = 0.9087
|
...
|      **[C.5]** **PLS: Partial Least Squares** (<mark style="background-color: #CCECFF">**pls**</mark> package)
|             **[C.5.1]** Root Mean Square Error = 2.6870
|             **[C.5.2]** R-Squared = 0.8644
|
...
|
| **[F]** The formulated model below showed consistently worse performance from both internal and external validation.  
|      **[F.1]** **PLS: Partial Least Squares** (<mark style="background-color: #CCECFF">**pls**</mark> package)
|
|
