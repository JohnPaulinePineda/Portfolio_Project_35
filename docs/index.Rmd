...
|
| [Root Mean Squared Error](https://link.springer.com/book/10.1007/978-0-387-84858-7) computes the square root of the average squared difference between the predicted and target values which ranges from zero to infinity. A value of zero indicates perfect prediction of the target values. The metric is weighted according to the square of the error - putting greater influence on large errors than smaller errors which makes it sensitive to outliers but may also encourage conservative prediction.
|
| [Median Absolute Deviation](https://link.springer.com/book/10.1007/978-0-387-84858-7) computes the median among all absolute difference between the predicted and target values which ranges from zero to infinity. A value of zero indicates perfect prediction of the target values. The metric gives less weight to large errors and is robust to outliers.
|
...
|
| **[A]** High correlation were noted for 7 pairs of numeric predictors with Pearson correlation coefficients >75% and p-values<0.05 as confirmed using the preprocessing summaries from the <mark style="background-color: #CCECFF">**caret**</mark> and <mark style="background-color: #CCECFF">**lares**</mark> packages.
|      **[A.1]** <span style="color: #FF0000">GDP</span> and <span style="color: #FF0000">GNI</span>  = +99.99%
|      **[A.2]** <span style="color: #FF0000">DPTIMM</span> and <span style="color: #FF0000">HEPIMM</span>  = +95.03%
|      **[A.3]** <span style="color: #FF0000">DPTIMM</span> and <span style="color: #FF0000">MEAIMM</span>  = +88.17%
|      **[A.4]** <span style="color: #FF0000">HEPIMM</span> and <span style="color: #FF0000">MEAIMM</span>  = +86.42%
|      **[A.5]** <span style="color: #FF0000">CLTECH</span> and <span style="color: #FF0000">SANSER</span>  = +86.21%
|      **[A.6]** <span style="color: #FF0000">INFMOR</span> and <span style="color: #FF0000">SANSER</span>  = -82.41%
|      **[A.7]** <span style="color: #FF0000">INFMOR</span> and <span style="color: #FF0000">CLTECH</span>  = -77.58%
|
|
...
|
| **[B]** Skewness measurrements were improved for most except for 1 numeric predictor with Skewness>3 
|      **[B.1]** <span style="color: #FF0000">SUIRAT</span> = 3.95
|
| **[C]** Outliers were minimized for most except for 9 numeric predictor which continued to have outlying points noted using the IQR criterion.
...
| **[Book]** [Applied Predictive Modeling](https://link.springer.com/book/10.1007/978-1-4614-6849-3) by Max Kuhn and Kjell Johnson
