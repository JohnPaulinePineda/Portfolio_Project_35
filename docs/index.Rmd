...
|
| Dataset used for the study was obtained from [Kaggle](https://www.kaggle.com/datasets/kiranshahi/life-expectancy-dataset) with all credits attributed to [Kiran Shahi](https://www.kaggle.com/kiranshahi). World [development](https://datatopics.worldbank.org/world-development-indicators/) and [health](https://data.worldbank.org/indicator/?tab=all) indicators in the dataset were primarily sourced from [The World Bank](https://www.worldbank.org/en/home).
|
...
|
| **[A]** <span style="color: #FF0000">LIFEXP</span> (numeric):
|
###  1.1.3 Predictors
|
| Detailed descriptions for each individual predictor used in the study are provided as follows:
|
| **[A]** <span style="color: #FF0000">COUNTRY</span> (character):
|
| **[B]** <span style="color: #FF0000">YEAR</span> (numeric):
|
| **[C]** <span style="color: #FF0000">GENDER</span> (factor):
|
| **[D]** <span style="color: #FF0000">CONTIN</span> (factor):
|
| **[E]** <span style="color: #FF0000">UNEMPR</span> (numeric):
|
| **[F]** <span style="color: #FF0000">INFMOR</span> (numeric):
|
| **[G]** <span style="color: #FF0000">GDP</span> (numeric):
|
| **[H]** <span style="color: #FF0000">GNI</span> (numeric):
|
| **[I]** <span style="color: #FF0000">CLTECH</span> (numeric):
|
| **[J]** <span style="color: #FF0000">PERCAP</span> (numeric):
|
| **[K]** <span style="color: #FF0000">RTIMOR</span> (numeric):
|
| **[L]** <span style="color: #FF0000">TUBINC</span> (numeric):
|
| **[M]** <span style="color: #FF0000">DPTIMM</span> (numeric):
|
| **[N]** <span style="color: #FF0000">HEPIMM</span> (numeric):
|
| **[O]** <span style="color: #FF0000">MEAIMM</span> (numeric):
|
