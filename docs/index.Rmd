...
# model development
##################################
MD <- MD[,c("INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED","LIFEXP")]

MD.Model.Predictors <- MD[,c("INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED")]

##################################
# Preparing the dataset for
# model test
##################################
MT <- MT[,c("INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED","LIFEXP")]
