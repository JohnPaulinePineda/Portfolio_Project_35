...
|
| **[A]** High correlation were noted for 7 pairs of numeric predictors with Pearson correlation coefficients >75% p-values<0.05 as confirmed using the preprocessing summaries from the <mark style="background-color: #CCECFF">**caret**</mark> and <mark style="background-color: #CCECFF">**lares**</mark> packages.
