...
# model development
##################################
MD <- MD[,c("GENDER","INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED","LIFEXP")]

MD.Model.Predictors <- MD[,c("GENDER","INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED")]

##################################
# Preparing the dataset for
# model test
##################################
MT <- MT[,c("GENDER","INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED","LIFEXP")]

MT.Model.Predictors <- MT[,c("GENDER","INFMOR","PERCAP","CLTECH","NCOMOR","TUBINC","URBPOP","HOSBED")]
...
##################################
GBM_DALEX_PartialDependencePlot_INFMOR <- model_profile(GBM_DALEX, variables = "INFMOR")
GBM_DALEX_PartialDependencePlot_NCOMOR <- model_profile(GBM_DALEX, variables = "NCOMOR")
GBM_DALEX_PartialDependencePlot_CLTECH <- model_profile(GBM_DALEX, variables = "CLTECH")
GBM_DALEX_PartialDependencePlot_PERCAP <- model_profile(GBM_DALEX, variables = "HOSBED")
GBM_DALEX_PartialDependencePlot_HOSBED <- model_profile(GBM_DALEX, variables = "HOSBED")
GBM_DALEX_PartialDependencePlot_URBPOP <- model_profile(GBM_DALEX, variables = "URBPOP")
GBM_DALEX_PartialDependencePlot_TUBINC <- model_profile(GBM_DALEX, variables = "TUBINC")
